...
// 🎴 1-200 የካርድ ቁልፎች መፍጠሪያ (መነሻቸው ነጭ ነው)
...
function selectCardTemporarily(cardNumber) {
    ...
    if (btn) {
        ...
        btn.style.backgroundColor = "#1e90ff"; // ምርጫ ሲደረግ ጊዜያዊ ሰማያዊ 💙
        btn.style.color = "#ffffff";
    }
}

// 🎯 CONFIRM PICKS የቁልፍ ማስተናገጃ አውቶማቲክ ሎጂክ
        ...
        try {
            ...
            if (result.success === true) {
                ...
                if (btn) {
                    btn.classList.remove("selected-temp");
                    btn.classList.add("bought");
                    btn.style.backgroundColor = "#ffcc00"; // ወደ ተያዘ (ቢጫ) ቀለም ይቀየራል 💛
                    btn.style.color = "#000000";
                }
...
// ⏱️ መልእክቱ መጥቶ ከ 2 ሰከንድ በኋላ በራሱ እንዲጠፋ ማድረጊያ (Auto-dismiss Toast)
