...
# 4. 🔄 100% የተስተካከለው የጨዋታ ሉፕ ሞተር (Game Loop Motor)
async def run_automated_game_loop():
    """
    በየ 30 ሰከንዱ ዙር እየቀያየረ የዳታቤዙን ሁኔታ 'running' የሚያደርግ 
    እና እጣዎችን የሚጥለው ዋናው ሞተር (ጃቫስክሪፕቱ እንዳይጋጭ የተደረገ)
    """
    ...
    while True:
        ...
        try:
            # 1. በዳታቤዝ ውስጥ አዲስ የነቃ ጨዋታ መፍጠር ወይም ያለውን መውሰድ
            ...
            # 💡 [ዋናው ማስተካከያ] ጃቫስክሪፕቱ ክራሽ እንዳያደርግ የዳታቤዙን ID ወደ ባለ 6 ዲጂት ቁጥር ቀይሮ ማዘጋጀት
        ...
        for seconds_left in range(30, -1, -1):
            await manager.broadcast({
                ...
                "time": seconds_left,
                "phase": "PICK",
                "game_no": game_display_no,  # 🎯 ለጃቫስክሪፕቱ ተሰጠ (ስክሪኑ እንዳይጠቁር)
                "ticket_price": 10.0,
                "total_players": 1,
                "total_pool": 10.0
            })
