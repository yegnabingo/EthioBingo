    ...
    async def start_game(self):
        ...
        while self.running:
            ...
            try:
                ...
                # 🛠 ፊክስ 1፡ ጨዋታውን መመዝገብ እና Deadlock የሚያመጣውን db.refresh() ማስወገድ
                game = Game(
                    status="running",
                ...
                # refresh() በመጠቀም ፈንታ የፈጠረውን ID በቀጥታ እንይዛለን
                ...
                # PICK PHASE
                await self.countdown(countdown_seconds, game_display_no, saved_game_id)
    ...
    async def countdown(self, seconds, game_display_no, saved_game_id):
        while seconds >= 0 and self.running:
            ...
            try:
                ...
                # 🛠 ፊክስ 2፡ በ ID አማካኝነት ጨዋታውን ደህንነቱ በተጠበቀ ሁኔታ ማደስ
                if saved_game_id:
                    try:
            ...
            # 🛠 ፊክስ 3፡ payload ሙሉ በሙሉ ደህንነቱ የተጠበቀ እና None የማይል መሆኑን ማረጋገጥ
            payload = {
                "type": "countdown",
                "seconds": seconds,
                "time": seconds,
